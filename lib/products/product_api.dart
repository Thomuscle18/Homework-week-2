...
import 'package:mytestapp/products/api_service.dart';
...
class _ProductListScreenState extends State<ProductListScreen> {
  ...
  void addProduct() async {
    ...
    if (confirmAdd == true) {
      var newProduct = await ApiService.addProduct(
        nameController.text,
      ...
      if (newProduct != null) {
        setState(() {
          products.add(newProduct); // เพิ่มสินค้าใหม่เข้ารายการ
        });
                ...
                children: [
                  ...
                  IconButton(
                    icon: Icon(Icons.edit,
                        color: const Color.fromARGB(255, 118, 130, 140)),
